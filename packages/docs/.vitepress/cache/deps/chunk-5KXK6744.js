...
var __assign = function() {
  __assign = Object.assign || function __assign8(t) {
...
var parseValidatorRules = function(rules) {
  ...
  var getContext = function(context, value) {
    return __assign4(__assign4(__assign4({}, rules), context), { value });
  };
      ...
      return __awaiter(void 0, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 1:
              _a.trys.push([1, 3, , 4]);
              return [4, callback(value, __assign4(__assign4({}, rules), { message }), context_, function(message2, scope) {
                var _a2;
                return (_a2 = render({
                  type: "error",
                  message: message2
...
var extendSameRules = function(rules, names) {
  each(names, function(realName, name) {
    rules[name] = function(value, rule) {
      ...
      return rules[realName].apply(rules, __spreadArray2([value, __assign5(__assign5({}, rule), (_a = {}, _a[realName] = rule[name], _a))], __read2(args), false));
    };
  });
};
var RULES = {
...
var queryFeedbacks = function(field, search) {
  return field.feedbacks.filter(function(feedback) {
    ...
    if (!((_a = feedback.messages) === null || _a === void 0 ? void 0 : _a.length))
      return false;
    return matchFeedback(search, __assign6(__assign6({}, feedback), { address: (_b = field.address) === null || _b === void 0 ? void 0 : _b.toString(), path: (_c = field.path) === null || _c === void 0 ? void 0 : _c.toString() }));
  });
};
...
var setValidatorRule = function(field, name, value) {
  ...
  if (hasRule) {
    field.validator = validators.map(function(desc) {
      if (isPlainObj(desc) && hasOwnProperty2.call(desc, name)) {
        desc[name] = value;
        return desc;
      }
      return desc;
...
var spliceArrayState = function(field, props) {
  var _a = __assign6({ startIndex: 0, deleteCount: 0, insertCount: 0 }, props), startIndex = _a.startIndex, deleteCount = _a.deleteCount, insertCount = _a.insertCount;
...
var exchangeArrayState = function(field, props) {
  var _a = __assign6({ fromIndex: 0, toIndex: 0 }, props), fromIndex = _a.fromIndex, toIndex = _a.toIndex;
  var address = field.address.toString();
...
var deserialize = function(model, setter) {
  ...
  if (isFn(setter)) {
    ...
    for (var key in setter) {
      if (!hasOwnProperty2.call(setter, key))
        continue;
      if (ReadOnlyProperties[key] || ReservedProperties[key])
        continue;
      var MutuallyExclusiveKey = MutuallyExclusiveProperties[key];
      if (MutuallyExclusiveKey && hasOwnProperty2.call(setter, MutuallyExclusiveKey) && !isValid(setter[MutuallyExclusiveKey]))
        continue;
...
var serialize = function(model, getter) {
  if (isFn(getter)) {
    ...
    for (var key in model) {
      if (!hasOwnProperty2.call(model, key))
        continue;
  ...
  function() {
    function BaseField2() {
      ...
      this.invoke = function(name) {
        ...
        return (_b = (_a = _this.actions)[name]) === null || _b === void 0 ? void 0 : _b.call.apply(_b, __spreadArray3([_a], __read3(args), false));
      };
    }
  ...
  return function() {
    ...
    if (GlobalState.effectStart) {
      GlobalState.lifecycles.push(new LifeCycle(type, function(payload, ctx) {
        if (isFn(callback)) {
          callback.apply(void 0, __spreadArray4([payload, ctx], __read4(GlobalState.context), false)).apply(void 0, __spreadArray4([], __read4(args), false));
        }
      }));
    } else {
    ...
    function ArrayField2(address, props, form, designable) {
      ...
      _this.push = function() {
        ...
        return action(function() {
          ...
          (_a = _this.value).push.apply(_a, __spreadArray5([], __read5(items), false));
      ...
      _this.insert = function(index) {
        ...
        return action(function() {
          ...
          (_a = _this.value).splice.apply(_a, __spreadArray5([index, 0], __read5(items), false));
          return _this.onInput(_this.value);
        });
      };
      ...
      _this.unshift = function() {
        ...
        return action(function() {
          ...
          (_a = _this.value).unshift.apply(_a, __spreadArray5([], __read5(items), false));
          return _this.onInput(_this.value);
        });
      };
  ...
  function() {
    function Form2(props) {
      ...
      this.createArrayField = function(props2) {
        ...
        if (!_this.fields[identifier] || _this.props.designable) {
          batch(function() {
            new ArrayField(address, __assign7(__assign7({}, props2), { value: isArr(props2.value) ? props2.value : [] }), _this, _this.props.designable);
          });
          _this.notify(LifeCycleTypes.ON_FORM_GRAPH_CHANGE);
        }
        return _this.fields[identifier];
      ...
      this.createObjectField = function(props2) {
        ...
        if (!_this.fields[identifier] || _this.props.designable) {
          batch(function() {
            new ObjectField(address, __assign7(__assign7({}, props2), { value: isObj(props2.value) ? props2.value : {} }), _this, _this.props.designable);
          });
          _this.notify(LifeCycleTypes.ON_FORM_GRAPH_CHANGE);
        }
        return _this.fields[identifier];
      ...
      this.queryFeedbacks = function(search) {
        return _this.query(search.address || search.path || "*").reduce(function(messages, field) {
          ...
          return messages.concat(field.queryFeedbacks(search).map(function(feedback) {
            return __assign7(__assign7({}, feedback), { address: field.address.toString(), path: field.path.toString() });
...
//# sourceMappingURL=chunk-5KXK6744.js.map
